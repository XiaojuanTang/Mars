...
def main():
    ...
    parser.add_argument('--load_world', type=pathlib.Path, default="final_world/world_terr_npc")
    parser.add_argument('--model', type=str, default="javris_v3_2_action_reflect_final")
    parser.add_argument('--fps', type=int, default=3)
    parser.add_argument('--wait', type=boolean, default=False)
    parser.add_argument('--episode', type=int, default=1)
    parser.add_argument('--memory_path', type=pathlib.Path, default="final_world/world_terr_npc/javris_v3_2_action_reflect_final/202405290349-gpt-4-0125-preview")
    ...
    task_selector = Task_Selector( logger=logger)
    task_plan = Task_Planner(logger=logger)
    reflector = Reflector( logger=logger)
    descriptor = Descriptor(logger=logger)
    
    controller = LLMcontroller( env=env, logger=logger)
    trial_limit = 3
