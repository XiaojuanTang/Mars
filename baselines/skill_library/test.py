...
def main():
    ...
    parser.add_argument('--model', type=str, default="javris_v3_2_action_reflect_final_std")
    parser.add_argument('--fps', type=int, default=3)
    parser.add_argument('--wait', type=boolean, default=False)
    parser.add_argument('--episode', type=int, default=4)
    parser.add_argument('--memory_path', type=pathlib.Path, default="final_world/default/javris_v3_2_action_reflect_final/202405222328-gpt-4-0125-preview")
