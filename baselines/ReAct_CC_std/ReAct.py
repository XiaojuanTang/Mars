...
def render_system_message() -> str:
    ...
    system_template = load_prompt('baselines/ReAct_CC_std/system_prompt_2.txt')
...
def main():
    ...
    parser.add_argument('--load_world', type=pathlib.Path, default="final_world/world_terr_npc_ach")
    parser.add_argument('--model', type=str, default="ReAct_final")
