...
REFLECTION_SYS = '''Here are some actions that the agent fails to perform in the 2D game. Here are some actions that the agent fails to perform in the game. Please give the explanation of action execution failure according to the current inventory information of the agent and history dialogue.
...
7) You are probably provided with some past successful plans and possible game mechanics that have been discovered to refer to.
