...
def main():
    ...
    parser.add_argument('--load_world', type=pathlib.Path, default="final_world/default")
    parser.add_argument('--model', type=str, default="induction_from_reflection_CC")
    parser.add_argument('--fps', type=int, default=3)
    parser.add_argument('--wait', type=boolean, default=False)
    parser.add_argument('--episode', type=int, default=3)
    parser.add_argument('--memory_path', type=pathlib.Path, default="final_world/default/induction_from_reflexion_std/202405312119-gpt-4-0125-preview")
    ...
    controller_reflector = LLMcontrollerReflector(path = all_path, induced_path=args.memory_path / 'reflection.txt', logger=logger)
    ...
    controller = LLMcontroller(induce=False, controller_reflector = controller_reflector, env=env, logger=logger)
    trial_limit = 3
